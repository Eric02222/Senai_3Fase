...
import CopyListButton from '../CopyButton/CopyButton.jsx';
                        ...
                        >
                            <CopyListButton
                                ...
                                items={[
                                    ...
                                    `Medicação: ${c.medication}`,
                                    `Dosagem: ${c.dosagePrecautions}`
                                ]}
                            />
...
hover:bg-gray-100 transition"
                        >
                            <CopyListButton
                                ...
                                items={[
                                    `Exame: ${exam.name}`,
                                    `Data: ${exam.date} - ${exam.time}`,
                                    `Tipo: ${exam.type}`,
                                    `Laboratório: ${exam.laboratory}`,
                                    `Documento: ${exam.documentUrl}`,
